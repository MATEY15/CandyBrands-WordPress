...
<header class="header" id="header">
    <div class="header__wrapper layout">
        ...
        <div class="header__burger"><span class="header__burger--open"> <svg width="20" height="16" viewBox="0 0 20 16"
                            ...
                            width="20" height="2" rx="1" fill="#FCAC10"/> <rect y="7" width="20" height="2" rx="1"
                                                                                fill="#FCAC10"/> <rect
                            y="14" width="20" height="2" rx="1" fill="#FCAC10"/> </svg> </span> <span
                    class="header__burger--close"> <svg
                        class="icon-close2" width="20px" height="20px"> <use
                            xlink:href="/img/icons/sprites.svg#icon-close2"></use> </svg> </span></div>
    </div>
